...
public:
	...
	virtual void SOCacheSubscribed( const GCSDK::SOID_t owner, GCSDK::ESOCacheEvent eEvent ) OVERRIDE;
	virtual void SOCacheUnsubscribed( const GCSDK::SOID_t owner, GCSDK::ESOCacheEvent eEvent ) OVERRIDE;

	// this
	uint64 GetTimePlayedConsecutively() const;
